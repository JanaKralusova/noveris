...
const translations = {
    sk: {
        ...
        // Page titles
        "title.home": "Noveris Legal — Advokátska kancelária",
        ...
        "home.hero.quote": "\"Právo nie je len o pravidlách, ale o riešeniach, ktoré umožňujú rast\"",
        "home.hero.quoteAuthor": "Jana Králusová, Zakladateľka",
        ...
        // Values
        "home.values.h2": "Naše základné hodnoty",
        "home.values.desc": "Piliere, na ktorých staviame každú jednu spoluprácu.",
        "home.values.trust.h3": "Dôvera",
        "home.values.trust.desc": "Budujeme dlhodobé vzťahy založené na absolútnej diskrétnosti a lojalite k vašim záujmom.",
        "home.values.responsibility.h3": "Zodpovednosť",
        "home.values.responsibility.desc": "Každý prípad riešime s maximálnou odbornou starostlivosťou a s ohľadom na najlepší záujem klienta.",
        "home.values.transparency.h3": "Transparentnosť",
        "home.values.transparency.desc": "Jasné pravidlá hry sú základom dlhodobého partnerstva. U nás vždy viete, na čom ste.",
        ...
        "home.services.showAll": "Zobraziť všetky oblasti poradenstva",

        // CTA
        "cta.h2": "Potrebujete právnu konzultáciu?",
        "cta.desc": "Kontaktujte nás a stručne opíšte vašu situáciu. Spoločne sa pozrieme na možnosti ďalšieho postupu.",
        ...
        // About values — reuse home.values keys
        ...
        "services.civil.desc": "Komplexná občianskoprávna agenda, dedenie, náhrada škody, bezdôvodné obohatenie a vyporiadanie bezpodielového spoluvlastníctva manželov",
        ...
        "contact.details.h2": "Kontakt",
        "contact.details.address.label": "Sídlo",
    ...
    en: {
        ...
        // Page titles
        "title.home": "Noveris Legal — Law Firm",
        ...
        "home.hero.quote": "\"Law is not just about rules, but about solutions that enable growth\"",
        "home.hero.quoteAuthor": "Jana Králusová, Founder",
        ...
        // Values
        "home.values.h2": "Our core values",
        "home.values.desc": "The pillars on which we build every collaboration.",
        "home.values.trust.h3": "Trust",
        "home.values.trust.desc": "We build long-term relationships based on absolute discretion and loyalty to your interests.",
        "home.values.responsibility.h3": "Responsibility",
        "home.values.responsibility.desc": "We handle every case with the utmost professional care and with regard to the client's best interest.",
        "home.values.transparency.h3": "Transparency",
        "home.values.transparency.desc": "Clear rules are the foundation of any long-term partnership. With us, you always know where you stand.",
        ...
        "home.services.corporate.desc": "Establishing and modifying business companies, corporate agenda, contractual documentation and company liquidation",
        "home.services.more": "More information",
        "home.services.showAll": "View all areas of expertise",

        // CTA
        "cta.h2": "Need a legal consultation?",
        "cta.desc": "Contact us and briefly describe your situation. Together we'll look at the options for next steps.",
        ...
        "about.quote.name": "Jana Králusová",
        "about.quote.role": "Founder & Attorney",
        "about.quote.text": "\"My philosophy is built on the belief that what matters is not just what is possible, but what is reasonable in a given situation.\"",
        ...
        "services.civil.desc": "Comprehensive civil law agenda, inheritance, damage compensation, unjust enrichment and settlement of marital community property",
        ...
        "contact.details.h2": "Contact",
        "contact.details.address.label": "Address",
        "contact.details.address": "Turčianska 42, 821 09 Bratislava, Slovakia",
        "contact.details.id.label": "Company ID",
        "contact.founder.role": "ATTORNEY & FOUNDER",
        "contact.founder.subtitle": "Legal services & consulting",

        "contact.form.h2": "Write to us",
        "contact.form.desc": "Have a question or looking for legal representation? Leave us a message and we will get back to you.",
